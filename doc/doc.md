...
| commons-io                   | 2.18.0       | [Apache License 2.0](/doc/licenses/ApacheLicense2.0.txt)  |1. NOTICE txt file according to section 4d: [NOTICE.txt](/doc/licenses/commons-io/NOTICE.txt) <br> 2. Information according to section 4b: Packages and classfiles of the library were renamed for technical reasons. This is also known as "shading" and was done via the [Maven Shade plugin](https://maven.apache.org/plugins/maven-shade-plugin/).|
| commons-text                 | 1.13.0       | [Apache License 2.0](/doc/licenses/ApacheLicense2.0.txt)  |1. NOTICE txt file according to section 4d: [NOTICE.txt](/doc/licenses/commons-text/NOTICE.txt) <br> 2. Information according to section 4b: Packages and classfiles of the library were renamed for technical reasons. This is also known as "shading" and was done via the [Maven Shade plugin](https://maven.apache.org/plugins/maven-shade-plugin/).|
| commons-codec                | 1.17.1       | [Apache License 2.0](/doc/licenses/ApacheLicense2.0.txt)  |1. NOTICE txt file according to section 4d: [NOTICE.txt](/doc/licenses/commons-codec/NOTICE.txt) <br> 2. Information according to section 4b: Packages and classfiles of the library were renamed for technical reasons. This is also known as "shading" and was done via the [Maven Shade plugin](https://maven.apache.org/plugins/maven-shade-plugin/).|
| gson                         | 2.11.0       | [Apache License 2.0](/doc/licenses/ApacheLicense2.0.txt)  |Information according to section 4b: Packages and classfiles of the library were renamed for technical reasons. This is also known as "shading" and was done via the [Maven Shade plugin](https://maven.apache.org/plugins/maven-shade-plugin/).|
| java-diff-utils              | 4.15         | [Apache License 2.0](/doc/licenses/ApacheLicense2.0.txt)  |Information according to section 4b: Packages and classfiles of the library were renamed for technical reasons. This is also known as "shading" and was done via the [Maven Shade plugin](https://maven.apache.org/plugins/maven-shade-plugin/).|
| javassist                    | 3.30.2-GA          | [Apache License 2.0](/doc/licenses/ApacheLicense2.0.txt)  |Information according to section 4b: Packages and classfiles of the library were renamed for technical reasons. This is also known as "shading" and was done via the [Maven Shade plugin](https://maven.apache.org/plugins/maven-shade-plugin/).|
| tinylog-api                  | 2.7.0                | [Apache License 2.0](/doc/licenses/ApacheLicense2.0.txt)  |Information according to section 4b: Packages and classfiles of the library were renamed for technical reasons. This is also known as "shading" and was done via the [Maven Shade plugin](https://maven.apache.org/plugins/maven-shade-plugin/).|
| tinylog-impl                 | 2.7.0                | [Apache License 2.0](/doc/licenses/ApacheLicense2.0.txt)  |Information according to section 4b: Packages and classfiles of the library were renamed for technical reasons. This is also known as "shading" and was done via the [Maven Shade plugin](https://maven.apache.org/plugins/maven-shade-plugin/).|
